...
namespace Rezervace.CustomControls
{
    public class CustomDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Rezervace.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Rezervace.Properties.Resources.calendarDark;
                else calendarIcon = Rezervace.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
